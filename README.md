Detta är en android-app som är skriven i Kotlin och som använder The Movie Database (TMDB). Api:n används för att söka efter filmer, se listor på populära filmer och visa detaljerad information om filmer. 
